# contacts = [('Mohamed Gouda', '+1-555-555-5555', 
# 'mohamedgouda@example.com'), ('Amira Abdelrahman', '+1-555-555-5556', 'amiraabdelrahman@example.com'), ('Abdullah Othman', 
# '+1-555-555-5557', 'abdullahothman@example.com'), ('Ahmed Saeed', '+1-555-555-5558', 'ahmedsaeed@example.com'), ('Saleh Abdelhamid', '+1-555-555-5559', 'salehabdelhamid@example.com'), 
...
# # loop in the list and save the values in a variable
...
# message = """Welcome to the phonebook application!
# 1. Add a contact
# 2. Update a contact
...
#     if user_choice == "1":
#         name_add = input("Enter name: ").title()
#         phone_add = input("Enter phone: ")
#         email_add = input("Enter email: ")
#         contacts.append((name_add, phone_add, email_add))
#         print("-" * 20)
        
        
#     elif user_choice == "2":
#         name_updated = input("Enter name of the contact you want to update: ")
#         i = 0
#         for lst in contacts:
            
#             found = False
#             if name_updated.title() in lst:
#                 phone_updated = input("Enter new phone number: ")
#                 email_updated = input("Enter new email:")
#                 lst_contact =  list(contacts[i])
#                 lst_contact = name_updated, phone_updated, email_updated
#                 tuple(lst_contact)
...
#             i +=1
#         if found == False:
#             print(f"sorry, there isn't contact name called '{name_updated}'")
#             print("-" * 20)
            
            
#     elif user_choice == "3":
#         search_name = input("Enter name of the contact you want to search: ")
#         condition = False
#         for tup in contacts:
            
#             name, phone, email = tup
#             if name == search_name.title():
#                 print(f"Name: {name}")
...
#                 condition = True
#         if condition == False:
#                 print(f"sorry, there isn't contact name called '{search_name}'")
#                 print("-" * 20)
...
#         exit()
#     else:
#         print("please choose a number btween 1 and 4 ")
#         print("-" * 20)
...
# user_input = input("Enter a country name or capital to search: ")
# found = False
# for lst in countries:
#     countery, capital, continent, language, population = lst
#     if user_input.title() in (countery, capital):
#         print(f"""Country:{countery}
# Capital: {capital}
# Continent: {continent}
# Language: {language}
...
https://www.programiz.com/online-compiler/865XvlWS8oNm6